  ...
  return (
    <div>
      ...
      <TwoCol>
        ...
        <Card>
          ...
          <div style={{marginBottom:10}}>
            ...
            <select style={{width:"100%",border:`1px solid ${C.border}`,borderRadius:8,padding:"8px 11px",fontSize:13,color:C.text,background:"#fff",boxSizing:"border-box"}}>
      ...
      <div style={{marginTop:12,display:"flex",gap:10,flexWrap:"wrap"}}>
        <Btn onClick={()=>toast(`POST ${API_BASE}/facturas/timbrar — RFC: ${form.rfc||"(vacío)"}`, "api")}>Timbrar con PAC →</Btn>
