...
import VentaDiaria from "./domains/facturacion/VentaDiaria";
...
import CalculoImpuestos from "./domains/facturacion/CalculoImpuestos";
...
const VIEWS={
  ...
  reporte:<ReporteMensual/>,costos:<DashboardCostos/>,contador:<CalculoImpuestos/>,lector:<LectorDocumentos/>,chat:<ChatFiscal/>,
