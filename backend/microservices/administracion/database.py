...
Series/folios consecutivos quedan fuera (tarea aparte, #12). Todavia no
existe modelo de tenants (#15 en Backlog) - Cliente.emisor_rfc es una
referencia suave (mismo patron que Factura.emisor_rfc en facturacion,
sin FK dura), no un tenant_id real.
"""
import os
